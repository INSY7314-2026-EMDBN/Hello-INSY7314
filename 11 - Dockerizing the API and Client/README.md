...
5. Stop the API and then run the container to make sure it runs. 
    ```
...
Dockerise your frontend with docker and docker compose.
You will need to conduct additional research to do this part on your own - but I am sure that you will be fine.